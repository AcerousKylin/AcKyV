...
subplot(2,2,3),imshow(LogFftShiftAbs,[]),xlabel('(c) 对称傅里叶幅度谱对数图像'),colormap(gray),colorbar;
subplot(2,2,4),mesh(FftShiftAbs),axis([0 50 0 50 0 300]),xlabel('(d) 傅里叶幅度谱三维图像'),colormap(gray),colorbar;
